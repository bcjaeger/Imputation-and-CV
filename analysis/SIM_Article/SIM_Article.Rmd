...
sim_desc <- read_rds(
  here::here('analysis/results/02-sim_descriptives.rds')
)

sim_tbls <- read_rds(
  here::here('analysis/results/03-sim_tabulate.rds')
)
...
```{r summarise-cvi-wins, include = FALSE}
...
ames <- read_rds(
  here::here('analysis/results/07-ames_tabulate.rds')
)
...
# TODO: fix the scaled values of R2 in this section (text should not be scaled.)
