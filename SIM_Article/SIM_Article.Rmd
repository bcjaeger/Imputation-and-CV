...
- num: b
  org: Very Important Stuff Committee, Institute B, City B, Country B
- num: c
...
The rest of this manuscript is organized as follows. In Section \ref{sec_app}, we summarize results from experiments using real data from public repositories. Results are summarized alongside our recommendations for applied practice in Section \ref{sec_discuss}

\section{Missing data and cross-validation} \label{sec_mdcv}
...
\section{Simulated experiments} \label{sec_sim}
...
\section{Real data experiments} \label{sec_app}

\section{Discussion and recommendations} \label{sec_discuss}
